<?php
  ...
  $conferencia = ($permGrafOs == '1') ? '<input type="submit" id="deletar"  class="btn btn-outline-secondary" value="Conferência"></input>' : '';
  $retorno = ($permGrafReq == '1') ? '<input type="submit" id="inserir" class="btn btn-outline-secondary" value="Retorno"></input>' : '';
  $triagem = ($permUsu == '1') ? '<input type="submit" id="inserir" class="btn btn-outline-secondary" value="Triagem"></input>' : '';
  $expedicao = ($permChat == '1') ? '<input type="submit" id="inserir" class="btn btn-outline-secondary" value="Expedição"></input>' : ''; 
  $retornoExp = ($permVendas == '1') ? '<input type="submit" id="inserir" class="btn btn-outline-secondary" value="Retorno Exp"></input>' : '';  
?>
<!doctype html>
<html lang="en">
    <head>
        ...
        <div class="cover-container d-flex h-100 p-3 mx-auto flex-column container-button">
          ...
          <div style="height: 30px; line-height: 10px; font-size: 8px;">&nbsp;</div>
            <main role="main" class="inner cover">
                <div class="divBtn">
                  <form class="form-btn" action="http://databitbh.com:51230/coletores/coletorconferencia/inicio.php">
                    <?php print($conferencia);?>
                  </form>
                  <form class="form-btn" action="http://databitbh.com:51230/coletores/coletorretornoexp/inicio.php">
                    <?php print($retornoExp);?>
                  </form>
                  <form class="form-btn" action="http://databitbh.com:51230/coletores/coletorretorno/inicio.php">
                    <?php print($retorno);?>
                  </form>
                  <form class="form-btn" action="http://databitbh.com:51230/coletores/coletortriagem/bip1.php">
                    <?php print($triagem);?>
                  </form>
                  <form class="form-btn" action="http://databitbh.com:51230/coletores/coletorexpedicao/inicio.php">
                    <?php print($expedicao);?>
                  </form>
                </div>
            </main>
