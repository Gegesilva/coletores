  ...
  <div>
      ...
      <div>
          ...
          <?php
              ...
              SELECT 1 Completo
              WHERE
                (SELECT SUM(QTDE) FROM GS_RETORNO LEFT JOIN TB01010 ON TB01010_CODIGO = PRODUTO WHERE CODIGO = '$pedido' AND TB01010_RETORNO = 'S' AND STATUS NOT IN ('21','22','23','24','01')) 
          ...
          <?php
              ...
              WHERE
                CODIGO = '$pedido'
                AND STATUS NOT IN ('21','22','23','24','01')
              GROUP BY
                CODIGO,
                PRODUTO,
                TB01010_NUMSERIE,
